    ...
    <>
      <section className="bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 mb-8 hover:bg-gray-700 transition-all">
            <Link
              to="/premiere-pro"
              className="bg-gray-700 text-blue-400 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2"
            >
              <svg
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 hover:bg-gray-700 transition-all">
              <Link
                to="/after-effects"
                className="bg-gray-700 text-green-400 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2"
              >
                <svg
                  className="w-2.5 h-2.5 me-1.5"
                  aria-hidden="true"
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 hover:bg-gray-700 transition-all">
              <Link
                to="/davinci-resolve"
                className="bg-gray-700 text-purple-400 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2"
              >
                <svg
                  className="w-2.5 h-2.5 me-1.5"
                  aria-hidden="true"
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 mb-8 hover:bg-gray-700 transition-all mt-5">
            <Link
              to="/windows-x64bit"
              className="bg-gray-700 text-blue-400 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2"
            >
            ...
            <Link to="/windows-x64bit">
              <h1 className="text-white text-3xl md:text-5xl font-extrabold mb-2">
                Windows Applications for windows users.
              </h1>
              <p className="text-lg font-normal text-gray-400 mb-6">
                Microsoft Windows is a operating system used by many people.
                With a wide range of features, everything from simple tasks to
                complicated tasks.
              </p>
            </Link>
          </div>
